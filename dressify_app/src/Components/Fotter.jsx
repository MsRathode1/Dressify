import { Divider, Flex, Heading, InputRightAddon,Input, HStack, InputGroup, Icon, IconButton, Text, VStack } from '@chakra-ui/react'
import React from 'react'
import { FaApple, FaGooglePlay, FaCheck ,FaLinkedinIn,FaFacebook,FaInstagram,FaTwitter,FaYoutube,FaPrint,FaWhatsapp} from "react-icons/fa"


const Fotter = () => {
  return (
    <>
      <Divider bg="gray.400" w="80%" m="auto" h={0.9} mt={20} orientation='horizontal' />
      ...
      <HStack alignItems="flex-start" border="0px solid black" fontSize="14px" fontStyle="Futura-Medium Century Gothic Gill Sans Helvetica Arial sans-serif" letterSpacing={0.5} justifyContent="space-between" width="80%" m="auto" mt={2}  >
        ...
        <VStack  border="0px solid black" alignItems="self-start" >
          <Heading size="sm">MYTHERESA</Heading>
